...
if((isset($_SESSION['ID'])))header("location:".FILE_INDEX);
?>
...
<body>
			...
			<div class="row-fluid">
				<div class="span12 center login-header">
					<h2>Welcome to Sungold Enterprises</h2>
				</div><!--/span-->
			</div><!--/row-->
				...
				<div class="well span5 center login-box">
					<div class="alert alert-info">
								<?php 
									...
									{
										echo "<font color='#FF0000' size='+1'>".$_SESSION['MSG']."</font>"; unset($_SESSION['MSG']);
									}
									else
									{
		...
		<br />
		<footer>
			<p align="center">&copy; 2016 Sungold Enterprises. All Rights are reserved.</a></p>
			<p align="center">Powered by: <a style="color:#FF00FF" href="http://www.techsysipl.com">Techsys Infotech Pvt. Ltd.</a></p>
		</footer>
